...
def parse_args():
    ...
    parser.add_argument('--enable_profiling', default=False, type=bool, help="Whether to enable profiling.")

    # Dataset path
    parser.add_argument('--data_root', default='./cocodataset', type=str,
                        help="File path of dataset in training.")

    # MaskRcnn training
    parser.add_argument('--only_create_dataset', default=False, type=bool, help="Whether to create dataset.")
    ...
    parser.add_argument('--do_eval', default=False, type=bool, help="Whether to do eval.")
    parser.add_argument('--dataset', default='coco', type=str, help="Dataset name")
    parser.add_argument('--pre_trained', default='./checkpoint/maskrcnn_coco2017_acc32.9.ckpt',
    ...
    # MaskRcnn evaluation
    parser.add_argument('--ann_file', default='./cocodataset/annotations/instances_test2017.json',
    ...
    parser.add_argument('--img_path', default='./cocodataset/test2017',
                        type=str, help="File path of dataset in inference.")
    parser.add_argument('--ann_path', default='./cocodataset/annotations/instances_test2017.json',
    ...
    parser.add_argument('--keep_ratio', default=True, type=bool, help="Whether to keep the same image scaling ratio.")
    ...
    # fpn
    parser.add_argument('--fpn_in_channels', default=[256, 512, 1024, 2048], #backbone #[128,256, 512, 1024]
    ...
    parser.add_argument('--use_sigmoid_cls', default=True, type=bool, help="Whether to use sigmoid for classification.")
    ...
    # train proposal
    parser.add_argument('--rpn_proposal_nms_across_levels', default=False, type=bool,
    ...
    # test proposal
    parser.add_argument('--rpn_nms_across_levels', default=False, type=bool,
    ...
    parser.add_argument('--rpn_head_use_sigmoid', default=True, type=bool,
    ...
    parser.add_argument('--epoch_size', default=7, type=int, help="The epoch size.")
    parser.add_argument('--save_checkpoint', default=True, type=bool, help="Whether to save checkpoint.")
    ...
    # cocodataset
    parser.add_argument('--mindrecord_dir', default='./cocodataset/MindRecord_COCO', type=str,
    ...
    parser.add_argument('--val_data_type', default='test2017', type=str,
